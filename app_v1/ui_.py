...
def generate_response(prompt, session_id, auto_generated=False):
    ...
    - IMPORTANTISSIMO: QUANDO DOVRAI COMPIALRE INFORMAZIONI SU DIEPDNENTI, AMMINSITRATORI ETCC.. OPPURE SU DATI FIANNZIARI E AMMINSITRATIVI, USA SOLOD ATI ESTRATTI DAL VECTOR STORE RELTIVO AL DOCUEMNTO DELLA VISURA, NON INVETARE MNOMI E DATI IN NESSUN MODO!!!!"""
