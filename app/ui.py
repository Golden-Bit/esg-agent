...
def generate_response(prompt, session_id, auto_generated=False):
    ...
    - Inoltre dovrai usufruire anche delle informazioni ottrnute dai forms e dai dati compilati in relazione alla azienda che si sta analizzando:
    ...
    - IMPORTANTISSIMO: COME NEL CASO DI TABELLE DIPENDENTI DIVISE PER SESSO O ETA' ETC.. PUO' CAPITARE CHE NON SINO REPERIBILI, IN TAL CASO NON SIVLUPAPRE TABELLE. IN QUALSIASI CASO NON RIPORTARE ASSOCLUTAMENTE MAI DATI NON CERTI. QUANDO DOVRAI COMPIALRE INFORMAZIONI SU DIEPDNENTI, AMMINSITRATORI ETCC.. OPPURE SU DATI FIANNZIARI E AMMINSITRATIVI, USA SOLOD ATI ESTRATTI DAL VECTOR STORE RELTIVO AL DOCUEMNTO DELLA VISURA, NON INVETARE MNOMI E DATI IN NESSUN MODO!!!!
    - IMPORTANTISSIMO: SE NON DISPONI DI INFORMAIZONI A SUFFICENZA PER CREARE TABELLA O GRAFICI DESCRITTI NELLE LINEE GUDA PER LA GENERAZIONE FORNITE IN PRECEDENZA, ALLORA NON GENENRALRI. NON FORNIRE MAI DATI CHE NON SINAO CERTI! (AD ESMEPIO SU UNMERO DIPENDENTI, NOMI AMMINISTRATORI, ETC...)
    - IMPORTANTISSIMO: UTILIZZA IL QUESTIONARIO FORNITO IN FORMS E IN BASE ALLA SEZIONE DI RIFERIMENTO (PARAGRAFO DEL REPORT) APPLICA LE REGOLE DI GENERAZIONE CONTENUTE NEL CAMPO 'content_generation_rules' DIOGNI ELEMENTO DEL FORM IN FUNZIONE DELLE RISPSOTE NEGLI OPPORTUNI PARAGRAFI. MIRACCOMANDO UTILIZZA LE INFROMAZIONI DELLE RISPSOTE DEL FORMS PER COMPILARE REPORT CON DATI ATTENDIBILI SEGUENDO INDICAIZONI MOSTRATE DA CAMPI 'content_generation_rules'."""
...
def generate_report(session_id):
    ...
    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 1.2 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_1_2}",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 1.2 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 1.3 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_1_3}",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 1.3 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 1.4 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_1_4}",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 1.4 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 1.5 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_1_5}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 1.5 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",


    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto 'Descrizione Cap. 2' (nel prossimo messaggio ti chieiderò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_2}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 'Descrizione Cap. 2' del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 2.1 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede .{linee_guida_2_1}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 2.1 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 2.2 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_2_2}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 2.2 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 2.3 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_2_3}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 2.3 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 2.4 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_2_4}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 2.4 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 2.5 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_2_5}.",
    # "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 2.5 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 2.6 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_2_6}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 2.6 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",


    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto 'Descrizione Cap. 3' (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_3}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 'Descrizione Cap. 3' del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 3.1 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_3_1}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 3.1 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 3.2 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_3_2}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 3.2 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 3.3 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_3_3}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 3.3 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",


    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto 'Descrizione Cap. 4' (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_4}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 'Descrizione Cap. 4' del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 4.1 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede.{linee_guida_4_1}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 4.1 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 4.2 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_4_2}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 4.2 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 4.3 (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_4_3}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 4.3 del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",


    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)...  contenuto sezione 'Conclusione' (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_conclusione}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 'Conclusione' del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 'Nota metodologica' (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_nota_motedologica}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 'Nota metodologica' del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 'Indice ESRS' (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_indice_esrs}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 'Indice ESRS' del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",

    f"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Sviluppa contenuto sezione 'Informazioni di contatto' (nel prossimo messaggio ti chiederò di inserire il contenuto generato nel template html). Genera contenuton in formato html, duqnue inserisci contenuto dettagliato ed eventualmente inserisci tabelle, grafici e diagrammi quando la situazione lo richiede. {linee_guida_info_contatto}.",
    #"Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... In base al contenuto appena generato per la sezione crea e salva effettivamente i grafici richiesti, duqnue riscrivi il contenuto html inserendo i link che puntano ai grafici salvati. I grafici salvati andranno visualizzati nell html della sezione centrati orizzontalmente.",
    "Il contenuto che svilupperai dovrà avere un stilo infromale e professionale, inoltre riporta solo dati e informazioni attendibili estratte dalle risorse fornite e inerenti l'azienda analizzata.Evita termini come 'benvenuti al' o 'nel nostro dna' etc.. Evita frasi del tipo 'Non sono riuscito a ottenere informazioni dettagliate dai vector stores' (non fare riferimento a vector store)... Inserisci contenuto generato nel messaggio precedente all'interno della sezione 'Informazioni di contatto' del template. USA assolutamente STRUMENTO replace_placeholder_in_html fornendo in input chiave e contenuti adatti in formato html",
]
