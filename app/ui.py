    ...
    with st.form("login_form"):
        ...
        if login_button:
            try:
                ...
                login_url = f"http://http://34.91.209.79:8000/login"
...
def documents_page():
    ...
    if st.button("Configura e Carica Catena", key="configure_chain_button", use_container_width=True):
        with st.spinner("Configurazione e caricamento della catena in corso..."):
            configure_chain_url = f"http://http://34.91.209.79:8000/configure_and_load_chain/?session_id={session_id}"
            try:
        ...
        if not session_id:
            ...
            for uploaded_file in uploaded_files:
                ...
                with st.spinner(f"Uploading and processing the document {file_id}..."):
                    ...
                    upload_document_url = f"http://http://34.91.209.79:8000/upload_document"
...
def dashboard_page():
    ...
    with st.form("create_user_form"):
        ...
        if submit_new_user:
            register_url = f"http://http://34.91.209.79:8000/register"
